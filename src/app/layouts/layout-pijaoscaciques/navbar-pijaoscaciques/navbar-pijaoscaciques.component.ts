...
@Component({
  selector: 'app-navbar-pijaoscaciques',
  templateUrl: './navbar-pijaoscaciques.component.html',
  styleUrls: ['./navbar-pijaoscaciques.component.scss']
})
export class NavbarPijaosCaciquesComponent implements OnInit {
